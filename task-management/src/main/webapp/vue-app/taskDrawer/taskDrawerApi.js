...
export function getTaskSteps(taskId) {
    return fetch(`/portal/rest/tasks/steps/${taskId}`, {
        method: 'GET',
        credentials: 'include',
    }).then((resp) => {
        if (resp && resp.ok) {
            ...
            throw new Error('Error when getting task steps');
        }
    })
}
...
export function addStepToTask(taskId, step) {
    return fetch(`/portal/rest/tasks/steps/${taskId}`, {
        headers: {
            Accept: 'application/json',
            'Content-Type': 'application/json',
        ...
        if (resp && resp.ok) {
            ...
            throw new Error('Error when adding step to task');
        }
    })
}

export function updateStep(stepId, step) {
    return fetch(`/portal/rest/tasks/steps/${stepId}`, {
        headers: {
            Accept: 'application/json',
            'Content-Type': 'application/json',
        },
        ...
        if (resp && resp.ok) {
            ...
            throw new Error('Error when updating step');
        }
    })
}
...
export function removeStep(taskId, stepId) {
    return fetch(`/portal/rest/tasks/steps/${taskId}/${stepId}`, {
        credentials: 'include',
        method: "delete",
    }).then((resp) => {
        if (resp && resp.ok) {
            ...
            throw new Error('Error when deleting step');
        }
    })
}
